...
public:
	...
	static void DrawArrow(const Vector3& p0, const Vector3& p1, double D);

	// For simple displaying of lines - takes two 3D positions
	// start and end of the line in the 3D world
	static void DrawLine(const Vector3& p0, const Vector3& p1);
	...
	static void RenderMesh(Mesh* msh, Matrix4 mvp);
};