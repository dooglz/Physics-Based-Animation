...
void Engine::createwindow() { Platform->createwindow(); }
...
bool Engine::Run() { return _running; }

void Engine::Stop() { _running = false; }
...
void Engine::SaveFile(const std::string& name) { Platform->SaveFile(name); }
}
