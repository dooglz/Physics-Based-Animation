...
class CPhysicsSolver {
 ...
 public:
  ...
  virtual CPhysicsObject* CreateCubeObject(float mass, Vector3 position,
                                           Quaternion rotation, float lw,
                                           float lh, float ld) = 0;
  virtual CPhysicsObject* CreateSphereObject(float mass, Vector3 position,
                                             Quaternion rotation,
                                             float radius) = 0;
  virtual CPhysicsObject* CreatePlaneObject(Vector3 position,
                                            Vector3 normal) = 0;
};
