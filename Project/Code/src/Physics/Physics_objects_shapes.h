...
class CCube_Object : public CPhysicsObject {
 ...
 public:
  CCube_Object(const float mass, const Vector3& position,
               const Quaternion& rotation, const float lw, const float lh,
               const float ld);
  ~CCube_Object() {}
...
class CSphere_Object : public CPhysicsObject {
 ...
 public:
  CSphere_Object(const float mass, const Vector3& position,
